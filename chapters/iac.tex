...
\end{itemize}
a ajouter les concepts de base de vault
le seal et unseal , le design de sécurité, les backends de stockage, les policies, les secrets engines, les auth methods
la distribution de clés seal pour un poweroff switch au pire des cas
...
\begin{itemize}
	...
	\item Les dépendances de base (cloud-init, agents QEMU).
